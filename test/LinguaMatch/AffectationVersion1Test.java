...
public class AffectationVersion1Test {
    ...
    void initialization() {
        ...
        affectation.ajouterCoupleHoteVisiteur(bellatrix, xolag, AffectationUtil.weight(bellatrix, xolag, null));
        affectation.ajouterCoupleHoteVisiteur(bellatrix, zander, AffectationUtil.weight(bellatrix, zander, null));
        affectation.ajouterCoupleHoteVisiteur(bellatrix, yak, AffectationUtil.weight(bellatrix, yak, null));

        affectation.ajouterCoupleHoteVisiteur(adonia, xolag, AffectationUtil.weight(adonia, xolag, null));
        affectation.ajouterCoupleHoteVisiteur(adonia, zander, AffectationUtil.weight(adonia, zander, null));
        affectation.ajouterCoupleHoteVisiteur(adonia, yak, AffectationUtil.weight(adonia, yak, null));

        affectation.ajouterCoupleHoteVisiteur(callista, xolag, AffectationUtil.weight(callista, xolag, null));
        affectation.ajouterCoupleHoteVisiteur(callista, zander, AffectationUtil.weight(callista, zander, null));
        affectation.ajouterCoupleHoteVisiteur(callista, yak, AffectationUtil.weight(callista, yak, null));
    }
