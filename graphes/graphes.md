...
Le rapport à rendre doit être au format pdf ou html (éventuellement format md lisible sur gitlab) et doit suivre le plan donné ici. Il doit se trouver dans un répertoire `graphes` à la racine de votre dépôt git.
...
- 50 : de base
- 50 : si il y a une incompatibilité allergie
- -10 : si il y a une affinité
